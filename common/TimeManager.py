"""
 Module. Time Management. Exercise of Programming 2 and Static Analysis 5.2
...
class TimeManager:
    ...
    """
    Time Manager. It is a module who handles all
    processes related to Time manipulation.
    """
